...
- 🔄 Multiple Formats: from ASCII to binary, Morse and Freedom Units
  ...
  - **Length**: `px`, `rem`, `em`, `pt`, `mm`, `cm`, `m`, `km`, `in`, `ft`, `yd`, `mi`, `barleycorn`, `hand`, `fathom`, `chain`, `furlong`, `league`, `nmi`, `link`, `rod`, `shackle`, `cable`, `palm`, `nail`, `finger`, `span`, `cubit`, `ell`, `bolt`, `clothyard`, `line`, `pica`, `thou`, `poppyseed`, `megalithicyard`, `pyramidinch`, `angstrom`, `ls`, `au`, `ly`, `pc`
